...
const demoGridSources: GridNode[] = [
  ...
  {
    id: "thessaloniki-load",
    name: "Thessaloniki Urban Hub",
    kind: "load",
    region: "Central Macedonia",
    latitude: 40.6401,
    longitude: 22.9444,
    mw: 520,
    detail: "Northern Greece demand hub",
  },
  {
    id: "athens-load",
    name: "Athens Urban Hub",
    kind: "load",
    region: "Attica",
    latitude: 38.14,
    longitude: 24.06,
  ...
  {
    id: "heraklion-load",
    name: "Heraklion Urban Hub",
    kind: "load",
    region: "Crete",
    latitude: 35.26,
    longitude: 25.42,
    mw: 260,
    detail: "Crete demand and interconnection hub",
  },
  {
    id: "north-hub",
    name: "North Grid Hub",
...
function buildGridFlows(sites: PortfolioSiteState[]): GridFlow[] {
  const flows: GridFlow[] = [
    ...
    flow("north-hub", "thessaloniki-load", "load", 260, "Supplying Thessaloniki urban hub"),
    flow("south-hub", "athens-load", "load", 420, "Supplying Athens load pocket"),
    flow("island-hub", "heraklion-load", "load", 180, "Supplying Heraklion urban hub"),
  ];
...
function loadNodeForSite(site: PortfolioSiteState) {
  if (site.id === "thessaloniki-flex") return "thessaloniki-load";
  if (site.id === "athens-west") return "athens-load";
  if (site.id === "crete-iraklio") return "heraklion-load";
